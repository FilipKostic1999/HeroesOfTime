...
var heroSpeed : Int = 10, var heroCurrentMana : Int = 10, var heroStrenght : Int = 10, var heroArmorId : Int = 1,
...
var heroInventorySlot5 : Int = 0, var heroMana : Int = 0, var heroDiamonds : Int = 0, var heroCurrentLocation : Int = 1) {
